...
import { celsius } from "../api/exFunction";
...
import { Newbox, NewText } from "./Component";
    ...
    return isLoading ? (
        ...
        <>
            <Box maxW={'1400px'} m={'20px auto 5px'} p={'20px'} minH={'550px'}>
                <Grid gridTemplateColumns={['100%', 'repeat(2, 1fr)', 'repeat(2, 1fr)', '30% 27.5% 38%']} gap={'30px'}>
                    ...
                    <Newbox  marginLeft={"100px"}>
                        <Grid templateColumns={'60% 40%'} h={'100%'} p={'8px'}>
                            ...
                            <Box borderRadius={'30px'} bg={'red'} py={'10px'} pl={'15%'}>
                ...
                <Grid mb={"3rem"} mt={'40px'} templateColumns={['repeat(2, 1fr)', 'repeat(3, 1fr)', 'repeat(4, 1fr)', 'repeat(5, 1fr)', 'repeat(8, 1fr)']} gap={'20px'}>
